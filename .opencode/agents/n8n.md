---
description: >-
  Use this agent when the user needs to create, debug, optimize, or explain n8n
  workflows. It is particularly useful for generating node configurations,
  writing JavaScript/Python code nodes, troubleshooting execution errors, or
  interacting with an n8n instance via MCP tools. 


  <example>

  Context: The user wants to create a webhook workflow.

  User: "I need a workflow that listens for a webhook and sends a slack
  message."

  Assistant: "I will use the n8n-architect agent to design that workflow for
  you."
  ...
  Context: The user has an error in a Code node.

  User: "Why is my map function failing in this n8n code node?"

  Assistant: "Let me have the n8n-architect agent analyze your code snippet."
